...
O dataset consiste em três workflows reais do n8n, totalizando 14 vulnerabilidades documentadas através de revisão manual especializada seguindo o framework OWASP LCNC Top 10. A Tabela \ref{tab:dataset-validation} apresenta as características do dataset.
...
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Workflow} & \textbf{Nós} & \textbf{Linhas} & \textbf{Vulnerabilidades} & \textbf{Classes} \\ \midrule
workflow\_1.json & 67 & 2.650 & 2 & Secret Deletion \\
workflow\_2.json & 100+ & 2.945 & 5 & SQL Injection (3x), Command Injection (2x) \\
workflow\_3.json & 17 & 605 & 7 & Diversos \\
\textbf{TOTAL} & \textbf{184+} & \textbf{6.200} & \textbf{14} & \textbf{6 classes} \\ \bottomrule
\end{tabular}
\end{table}
